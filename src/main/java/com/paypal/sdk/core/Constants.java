...
{
    public static final boolean TRUST_ALL = false;
    public static final String DEFAULT_API_VERSION = "89.0";
    public static final String API_SOURCE = "PAYPAL_JAVA_SDK_89.0";
